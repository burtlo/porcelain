...
(function () {
  ...
  var aliasToCanonical = {
    ...
    "gateway operator workspace reindex requested": "gateway.operator.workspace.reindex_requested",
    ...
    "assistant fallback attempt": "chat.routing.attempt",
    "assistant routing resolved": "chat.routing.resolved",
  ...
  var bySlug = {
    ...
    "gateway.operator.workspace.reindex_requested": {summary: "Re-index requested · workspace 3 · generation 2", formatter: "gateway_operator_workspace_reindex_requested"},
    ...
    "gateway.assistant.bootstrap_failed": {summary: "Assistant registry bootstrap failed during gateway startup."},
    "gateway.assistant.bootstrap_imported": {summary: "Legacy assistant definitions imported during gateway bootstrap."},
    "gateway.assistant.gemini_seeded": {summary: "Default Gemini assistant seeded in the operator store."},
    "gateway.assistant.reload_failed": {summary: "Assistant registry reload failed after bootstrap."},
    ...
    "chat.routing.assistant_skipped": {summary: "Assistant routing skipped a model in the fallback chain (HTTP 413 on an earlier attempt this request)."},
  ...
  var Slug = {
    ...
    MsgGatewayAssistantBootstrapFailed: "gateway.assistant.bootstrap_failed",
    MsgGatewayAssistantBootstrapImported: "gateway.assistant.bootstrap_imported",
    MsgGatewayAssistantGeminiSeeded: "gateway.assistant.gemini_seeded",
    MsgGatewayAssistantReloadFailed: "gateway.assistant.reload_failed",
    ...
    MsgChatRoutingAssistantSkipped: "chat.routing.assistant_skipped",
